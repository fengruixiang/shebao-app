...
var mui = (function (a, b) {
  var c = /complete|loaded|interactive/,
    ...
    j = function (a, b) {
      return (
        (a = a || []), Object.setPrototypeOf(a, i.fn), (a.selector = b || ""), a
      );
    };
  (i.uuid = 0),
    (i.data = {}),
    ...
    (i.trigger = function (a, b, c) {
      return (
        a.dispatchEvent(
          new CustomEvent(b, { detail: c, bubbles: !0, cancelable: !0 })
        ),
        this
      );
    }),
...
!(function (a, b) {
          ...
          if (
            (a.each(a.targetHandles, function (c, g) {
              ...
              f || e[h] || !g.hasOwnProperty("handle")
                ? e[h] || (g.isReset !== !1 && (a.targets[h] = !1))
                : ((a.targets[h] = g.handle(b, d)),
                  a.targets[h] &&
                    ((e[h] = !0), g.isContinue !== !0 && (f = !0)));
            }),
            f)
          )
            break;
  ...
  (function () {
    ...
    "undefined" == typeof window.CustomEvent &&
    ...
    if (!b.FastClick) {
      var d = function (a, b) {
        return (
          "LABEL" === b.tagName &&
            b.parentNode &&
            (b = b.parentNode.querySelector("input")),
          !b || ("radio" !== b.type && "checkbox" !== b.type) || b.disabled
            ? !1
            : b
        );
      };
      ...
      b.addEventListener("tap", e),
        ...
        b.addEventListener(
          "click",
          function (b) {
            return a.targets.click && !b.forwardedTouchEvent
        ...
        b.addEventListener("focusin", function (h) {
          if (
            ...
            if (
              i.tagName &&
              "INPUT" === i.tagName &&
              ("text" === i.type || "search" === i.type || "number" === i.type)
            ) {
  ...
  (function (a) {
    var b = 1,
      ...
      j = function (b, d, e, f) {
        return function (e) {
          for (
            var f = c[b._mid][d], h = [], i = e.target, j = {};
            i &&
            i !== document &&
            i !== b &&
            (!~["click", "tap", "doubletap", "longtap", "hold"].indexOf(d) ||
              (!i.disabled && !i.classList.contains("mui-disabled")));
            i = i.parentNode
          ) {
            var k = {};
            a.each(
  ...
  (function (a, b) {
    ...
    var c = Math.round,
      ...
      m = function (b, c) {
        a.gestures.stoped ||
          a.doAction("gestures", function (d, e) {
            a.gestures.stoped ||
              (a.options.gestureConfig[e.name] !== !1 && e.handle(b, c));
          });
      },
      n = function (a, b) {
        for (; a; ) {
      ...
      v = function (b) {
        ...
        if (
          b.gesture.type != a.EVENT_CANCEL &&
          (k > u || void 0 === i.velocity)
        ) {
      ...
      x = function (b, c) {
        ...
        if ((e !== a.EVENT_START && e !== a.EVENT_MOVE) || 1 !== d.length) {
          ...
          for (h = 0; h < i.length; )
            w[i[h].identifier] && g.push(i[h]),
              (e === a.EVENT_END || e === a.EVENT_CANCEL) &&
                delete w[i[h].identifier],
              h++;
        ...
        return (
          ...
          (c.isFinal =
            (e === a.EVENT_END || e === a.EVENT_CANCEL) && k - l === 0),
          (c.touches = f),
          (c.changedTouches = g),
          !0
        );
    ...
    b.addEventListener(a.EVENT_START, y),
      b.addEventListener(a.EVENT_MOVE, y),
      b.addEventListener(a.EVENT_END, y),
      b.addEventListener(a.EVENT_CANCEL, y),
      b.addEventListener(
        a.EVENT_CLICK,
        function (b) {
        ...
        switch (e.type) {
          case a.EVENT_END:
            ...
            if (
              !i ||
              i.disabled ||
              (i.classList && i.classList.contains("mui-disabled"))
            )
              return;
            if (f.distance < h.tapMaxDistance && f.deltaTime < h.tapMaxTime) {
              if (
                ...
                return (
                  a.trigger(i, "doubletap", f), (d = a.now()), void (c = i)
                );
        ...
        case a.EVENT_MOVE:
          if (a.options.gestureConfig.pinch) {
            ...
            g > i
              ...
              : i > g && ((i = g + j), a.trigger(f.target, b + "in", d)),
              Math.abs(h) > e.minRotationAngle &&
                a.trigger(f.target, "rotate", d);
          }
          break;
        case a.EVENT_END:
        case a.EVENT_CANCEL:
    ...
    (a.init = function (d) {
      ...
      a(function () {
        ...
        a.os.ios
          ...
          : a.os.android &&
            (c.push({ os: "android", version: a.os.version }),
            b.add("mui-android")),
          a.os.wechat &&
            (c.push({ os: "wechat", version: a.os.wechat.version }),
            b.add("mui-wechat")),
          c.length &&
      ...
      if (window.plus) {
        ...
        if (a.webviews[c]) {
          ...
          return (
            (g = k.webview),
            (g && g.getURL()) ||
              ((f = a.extend(f, { id: c, url: b, preload: !0 }, !0)),
              (g = a.createWindow(f))),
            (h = k.show),
            (h = f.show ? a.extend(h, f.show) : h),
            g.show(h.aniShow, h.duration, function () {
              d(g), e(g, "pagebeforeshow", !1);
            }),
            k.afterShowMethodName &&
              g.evalJS(k.afterShowMethodName + "('" + JSON.stringify(j) + "')"),
            g
          );
        }
        ...
        return (
          l.autoShow && (i = plus.nativeUI.showWaiting(l.title, l.options)),
          (f = a.extend(f, { id: c, url: b })),
          (g = a.createWindow(f)),
          (h = a.showOptions(f.show)),
          h.autoShow &&
            g.addEventListener(
              ...
              function () {
                i && i.close(),
                  ...
                  (g.showed = !0),
                  f.afterShowMethodName &&
                    g.evalJS(
                      f.afterShowMethodName + "('" + JSON.stringify(j) + "')"
                    );
              },
              !1
            ),
        ...
        if (window.plus) {
          ...
          if (b.preload) {
            a.webviews[e] && a.webviews[e].webview.getURL()
              ...
              : (b.createNew !== !0 && (d = plus.webview.getWebviewById(e)),
                d ||
  ...
  (function (a, b) {
    (a.addBack = function (b) {
      ...
      (a.back = function () {
        ("function" != typeof a.options.beforeback ||
          a.options.beforeback() !== !1) &&
          a.doAction("backs");
      }),
  ...
  (function (a, b) {
    a.os.plus &&
      ...
      a.addBack({
        ...
        handle: function () {
          if (
            a.targets._popover &&
            a.targets._popover.classList.contains("mui-active")
          )
              ...
              : c.canBack(function (d) {
                  d.canBack
                    ...
                    : c.id === plus.runtime.appid ||
                      (c.preload ? c.hide("auto") : a.closeAll(c));
                }),
            !0
          );
        },
    ...
    a.plusReady(function () {
      a.options.keyEventBind.backbutton &&
        plus.key.addEventListener("backbutton", c, !1),
    ...
    var j = function (a, b) {
      ...
      r = function (b, d, e, f) {
        return (
          ...
          { url: b, data: d, success: e, dataType: f }
        );
      };
    (a.ajax = function (d, e) {
      ...
      o(f);
      var h = f.dataType;
      (f.cache !== !1 && ((e && e.cache === !0) || "script" !== h)) ||
      ...
      if (
        ...
        (f.contentType ||
          (f.contentType !== !1 && f.data && "GET" !== f.type.toUpperCase())) &&
          s(
            "Content-Type",
      ...
      v = {
        ...
        _createPocket: function (a, c, d) {
          ...
          return (
            (e.className = a),
            (e.innerHTML = u
              .replace("{contentrefresh}", c.contentrefresh)
              .replace("{icon}", d)),
            e
          );
        },
      ...
      k = a.Class.extend({
        ...
        _initParallax: function () {
          this.options.parallaxElement &&
            ((this.parallaxElement = c.querySelector(
              this.options.parallaxElement
            )),
        ...
        _initIndicators: function () {
          ...
          if (((a.indicators = []), this.options.indicators)) {
            var b,
              c = [];
            a.options.scrollY &&
              ((b = { el: this._createScrollBar(g), listenX: !1 }),
              this.wrapper.appendChild(b.el),
              c.push(b)),
              this.options.scrollX &&
                ((b = { el: this._createScrollBar(h), listenY: !1 }),
                this.wrapper.appendChild(b.el),
                c.push(b));
        ...
        _initSnap: function () {
          ...
          for (
            ...
            var h = a[g],
              j = h.offsetLeft,
              k = h.offsetWidth;
            (0 === g || j <= a[g - 1].offsetLeft) && ((c = 0), d++),
              this.pages[c] || (this.pages[c] = []),
              (e = this._getSnapX(j)),
              (f = e - Math.round(k / 2)),
              (this.pages[c][d] = { x: e, cx: f, pageX: c, element: h }),
        ...
        _getSnapX: function (a) {
          return Math.max(
            Math.min(0, -a + this.wrapperWidth / 2),
            this.maxScrollX
          );
        },
        _gotoPage: function (a) {
          ...
          for (var b = 0, c = this.snaps.length; c > b; b++)
            b === a
              ? this.snaps[b].classList.add(i)
              : this.snaps[b].classList.remove(i);
        ...
        _initEvent: function (c) {
          ...
          b[d]("orientationchange", this),
            ...
            this.wrapper[d]("touchstart", this),
            this.wrapper[d]("touchcancel", this),
            this.wrapper[d]("touchend", this),
          ...
          e && mui(e)[c ? "off" : "on"]("click", "a", a.preventDefault),
            this.wrapper[d](
              "scrollend",
              this._handleIndicatorScrollend.bind(this)
            ),
            this.wrapper[d](
              "scrollstart",
              this._handleIndicatorScrollstart.bind(this)
            ),
            this.wrapper[d]("refresh", this._handleIndicatorRefresh.bind(this));
        },
        ...
        _start: function (b) {
          if (
            ...
            this.isInTransition && this.moved)
          ) {
            (this.needReset = !0), (this.isInTransition = !1);
            var c = a.parseTranslateMatrix(
              a.getStyles(this.scroller, "webkitTransform")
            );
        ...
        _drag: function (c) {
          ...
          if (
            ("left" === d.direction || "right" === d.direction
              ...
              : (isReturn = !0),
            (this.moved || f) &&
              (c.stopPropagation(), d.gesture && d.gesture.preventDefault()),
            !isReturn)
          ) {
            this.moved
              ? c.stopPropagation()
            ...
            (k > 0 || k < this.maxScrollX) &&
              (k = this.options.bounce
                ? this.x + g / 3
                : k > 0
                ? 0
                : this.maxScrollX),
              (l > 0 || l < this.maxScrollY) &&
                (l = this.options.bounce
                  ? this.y + h / 3
                  : l > 0
                  ? 0
                  : this.maxScrollY),
              ...
              if (
                ...
                return (
                  ...
                  d != this.x || e != this.y
                    ...
                    : void a.trigger(this.scroller, "scrollend", this)
                );
              }
            }
          }
        ...
        _end: function (a) {
          (this.needReset = !1),
            ((!this.moved && this.needReset) || "touchcancel" === a.type) &&
              this.resetPosition();
        },
        ...
        _createScrollBar: function (a) {
          ...
          return (
            ...
            a === g
              ...
              : a === h &&
                ((this.scrollbarX = b), (this.scrollbarIndicatorX = d)),
        ...
        _reLayout: function () {
          if (
            ...
            for (var b = 0, c = a.length; c > b; b++) {
              var d = a[b];
              d.parentNode === this.scroller &&
                (this.itemLength++, this.snaps.push(d));
            }
            this._initSnap();
          }
        },
          ...
          return (
            ...
            e > h
              ...
              : h > 0 &&
                ...
                (b = Math.abs(a) + h),
                (i = b / j)),
            { destination: Math.round(h), duration: i }
          );
        },
        ...
        resetPosition: function (a) {
          ...
          return (
            ...
            b == this.x && c == this.y
              ? !1
              : (this.scrollTo(b, c, a, this.options.bounceEasing), !0)
          );
        },
        refresh: function () {
          this.reLayout(),
        ...
        a < this.minBoundaryX
          ...
          b < this.minBoundaryY
            ...
            ? ((this.height = Math.max(
                this.indicatorHeight - 3 * (b - this.maxPosY),
                8
              )),
              (this.indicatorStyle.height = this.height + "px"),
          ...
          (this.x = a),
          (this.y = b),
          (this.indicatorStyle.webkitTransform = this.scroller._getTranslateStr(
            a,
            b
          ));
      },
        ...
        a.extend(
          {
            ...
            pulldownLoading: function (a, b) {
              if (
                ("undefined" == typeof a && (a = this.options.down.height),
  ...
  (function (a, b) {
    var c = "mui-slider",
      ...
      n = (a.Slider = a.Scroll.extend({
        ...
        _init: function () {
          for (
            var a = this.wrapper.querySelectorAll("." + d), b = 0, c = a.length;
            c > b;
            b++
          )
          ...
          this.scroller &&
            ...
            (this.progressBar = this.wrapper.querySelector(m)),
            this.progressBar &&
          ...
          if (b.target === c.wrapper) {
            ...
            if (
              ...
              for (var g = 0, h = e.length; h > g; g++) {
                var i = e[g];
                i.parentNode === c.scroller &&
                  (g === f ? i.classList.add(j) : i.classList.remove(j));
              }
            var l = c.wrapper.querySelector(".mui-slider-indicator");
            if (l) {
              l.getAttribute("data-scroll") &&
                a(l).scroll().gotoPage(d.slideNumber);
              ...
              if (m.length > 0)
                ...
                if (n) n.innerText = d.slideNumber + 1;
                  ...
                  for (
                    var o = c.wrapper.querySelectorAll(".mui-control-item"),
                      g = 0,
                      h = o.length;
                    h > g;
                    g++
        ...
        _handleIndicatorTap: function (a) {
          var b = this,
            c = a.target;
          (c.classList.contains(g) || c.classList.contains(h)) &&
            (b[c.classList.contains(g) ? "prevItem" : "nextItem"](),
            a.stopPropagation());
        },
        _initEvent: function (b) {
          ...
          c.wrapper[d]("swiperight", a.stopPropagation),
            c.wrapper[d]("scrollend", c._triggerSlide.bind(this)),
            c.wrapper[d]("slide", c._handleSlide.bind(this)),
            c.wrapper[d](
              a.eventName("shown", "tab"),
              c._handleTabShow.bind(this)
            );
          ...
          e && b.clearTimeout(e),
            d &&
              ((e = b.setTimeout(function () {
                c &&
                  ((c.offsetWidth || c.offsetHeight) && a.nextItem(!0),
                  a._initTimer());
              }, d)),
          ...
          if (
            ...
            (this.slideNumber = this._fixedSlideNumber()),
              (this.lastSlideNumber =
                "undefined" == typeof this.lastSlideNumber
                  ? this.slideNumber
                  : this.lastSlideNumber);
          else {
          ...
          return (
            this.loop
              ...
              : (b ||
                  (a > this.itemLength - 1
                    ? ((a = 0), (time = 0))
                    : 0 > a && ((a = this.itemLength - 1), (time = 0))),
        ...
        setTranslate: function (a, b) {
          ...
          c &&
            (this.progressBarStyle.webkitTransform = this._getTranslateStr(
              -a * (this.progressBarWidth / this.wrapperWidth),
              0
            ));
        },
        resetPosition: function (a) {
        ...
        gotoItem: function (a, b) {
          this._gotoItem(
            a,
            "undefined" == typeof b ? this.options.bounceTime : b
          );
        },
        nextItem: function () {
        ...
        refresh: function (b) {
          b
            ? (a.extend(this.options, b), this._super(), this.nextItem())
            : this._super();
        },
        destory: function () {
          this._initEvent(!0),
      ...
      return (
        this.each(function () {
          ...
          if (
            ...
            f
              ? ((d = a.data[f]), d && b && d.refresh(b))
              : ((f = ++a.uuid),
                (a.data[f] = d = new n(e, b)),
    ...
    if (a.os.plus && a.os.android) {
                    ...
                    function (d) {
                      switch (
                        ...
                        case "dragEndAfterChangeOffset":
                          a.evalJS(
                            "mui&&mui.options.pullRefresh.down.callback()"
                          ),
          ...
          a.extend(
            {
              setStopped: function (a) {
                ...
                var b = plus.webview.currentWebview();
                if (this.stopped)
                  b.setStyle({ bounce: "none" }),
                    b.setBounce({ position: { top: "none" } });
                else {
              ...
              _pulldownLoading: function () {
                ...
                a.plusReady(function () {
                  plus.webview
                    .getWebviewById(b.options.webviewId)
                    .evalJS(
                      "mui&&mui.options.pullRefresh.down&&mui.options.pullRefresh.down.callback()"
                    );
                });
              },
              endPulldownToRefresh: function () {
              ...
              endPullupToRefresh: function (a) {
                ...
                b.pullLoading &&
                  ...
                  b.pullLoading.classList.add(e),
                  (b.isLoading = !1),
                  a
                    ? ((b.finished = !0),
                      (b.pullCaption.className = g + " " + j),
                      (b.pullCaption.innerHTML = b.options.up.contentnomore),
                      window.removeEventListener("dragup", b))
                    : ((b.pullCaption.className = g + " " + h),
                      (b.pullCaption.innerHTML = b.options.up.contentdown)));
              },
              disablePullupToRefresh: function () {
                this._initPullupRefresh(),
      ...
      a.fn.pullRefresh = function (d) {
        ...
        return (
          ...
          d.down && d.down.auto
            ? f._pulldownLoading()
            : d.up && d.up.auto && f.pullupLoading(),
          f
        );
      };
    }
    ...
    var e = "mui-off-canvas-left",
      ...
      m = a.Class.extend({
        init: function (b, d) {
          (this.wrapper = this.element = b),
            ...
            this.scroller &&
              ((this.options = a.extend(
                !0,
                { dragThresholdX: 10, scale: 0.8, opacity: 0.1 },
                d
              )),
        ...
        handleEvent: function (b) {
          switch (b.type) {
            ...
            case "drag":
              var d = b.detail;
              this.startX
                ? (this.lastX = d.center.x)
                : ((this.startX = d.center.x), (this.lastX = this.startX)),
                !this.isDragging &&
                  ...
                  (this.slideIn
                    ? ((this.scroller = this.wrapper.querySelector(l)),
                      this.classList.contains(j)
                        ? this.offCanvasRight &&
                          this.offCanvasRight.classList.contains(j)
                        ...
                        ? ((this.offCanvas = this.offCanvasRight),
                          (this.offCanvasWidth = this.offCanvasRightWidth))
                        : "right" === d.direction && this.offCanvasLeft
                        ? ((this.offCanvas = this.offCanvasLeft),
                          (this.offCanvasWidth = this.offCanvasLeftWidth))
                        : (this.scroller = null))
                    : this.classList.contains(j)
              ...
              if (this.isDragging) {
                ...
                if (this.slideIn) {
                  ...
                  f > 0 && 0.5 > f && "right" === e
                    ...
                    : 0.5 > f && "right" === e
                    ? this.openPercentage(-100)
                    : "right" === e && f >= 0 && (f >= 0.5 || d.flick)
                    ? this.openPercentage(100)
                    : "left" === e && 0 >= f && (-0.5 >= f || d.flick)
                    ? this.openPercentage(-100)
                    : this.openPercentage(0),
        ...
        initEvent: function () {
          var a = this;
          a.backdrop &&
            a.backdrop.addEventListener("tap", function (b) {
        ...
        updateTranslate: function (b) {
          if (b !== this.lastTranslateX) {
            if (this.slideIn) {
              ...
              if (
                (!this.offCanvasLeft && b > 0) ||
                (!this.offCanvasRight && 0 > b)
              )
        ...
        show: function (a) {
          return (
            ...
            this.isShown(a)
              ? !1
              : (a ||
                  (a = this.wrapper.querySelector("." + f) ? "right" : "left"),
                "right" === a
                  ? ((this.offCanvas = this.offCanvasRight),
                    (this.offCanvasWidth = this.offCanvasRightWidth))
                  : ((this.offCanvas = this.offCanvasLeft),
      ...
      r = (function () {
        ...
        return (
          ...
          b.addEventListener("tap", function (b) {
            ...
            d &&
              (d.addEventListener("webkitTransitionEnd", q),
      ...
      v = function (d, e, h) {
        if (d && e) {
          ...
          var i = b.innerWidth,
            ...
            q = d.querySelector("." + f);
          q ||
            ((q = c.createElement("div")), (q.className = f), d.appendChild(q));
  ...
  (function (a, b, c, d, e) {
    var f = "mui-control-item",
      ...
      k = function (a, b) {
        return b.classList &&
          (b.classList.contains(f) || b.classList.contains(j))
          ? (a.preventDefault(), b)
          : !1;
      };
    a.registerTarget({ name: d, index: 80, handle: k, target: !1 }),
      b.addEventListener("tap", function (b) {
        var e = a.targets.tab;
        if (e) {
          for (
            var k, l, m, n = "mui-active", o = "." + n, p = e.parentNode;
            p && p !== c;
            p = p.parentNode
          ) {
            if (p.classList.contains(g)) {
              k = p.querySelector(o + "." + f);
              break;
            }
            p.classList.contains(i) && (k = p.querySelector(o + "." + j));
          }
          ...
          if (
            ...
            if (!q) {
              var r = m.parentNode;
              l = r.querySelectorAll("." + h + o);
              for (var s = 0; s < l.length; s++) {
                var t = l[s];
                t.parentNode === r && t.classList.remove(n);
              }
              m.classList.add(n);
              var u = m.parentNode.querySelectorAll("." + h);
        ...
        if (translateX !== lastTranslateX) {
          if (buttonsRight && buttonsRight.length > 0) {
            ...
            for (var a = 0, b = buttonsRight.length; b > a; a++) {
              ...
              "undefined" == typeof c._buttonOffset &&
                (c._buttonOffset = c.offsetLeft),
          ...
          if (buttonsLeft && buttonsLeft.length > 0) {
            ...
            for (var a = 0, b = buttonsLeft.length; b > a; a++) {
              var d = buttonsLeft[a];
              "undefined" == typeof d._buttonOffset &&
                (d._buttonOffset =
                  sliderActionLeftWidth - d.offsetLeft - d.offsetWidth),
                (buttonOffset = d._buttonOffset),
                buttonsLeft.length > 1 &&
                  (d.style.zIndex = buttonsLeft.length - a),
        ...
        if (e) {
          z ||
            ...
            A &&
              ...
              isOpened &&
                (openedActions = e.querySelector(u + w) ? "left" : "right")));
          var b = a.detail,
            c = b.direction,
            d = b.angle;
          if (
            ...
            if (
              ...
              k.parentNode.classList.add(h),
                ...
                isOpened ||
                  a.trigger(
                    e,
                    "toLeft" === sliderDirection ? "slideleft" : "slideright"
                  );
            }
          } else
            E(A, 0),
          ...
          if (buttonsLeft && buttonsLeft.length > 0 && buttonsLeft !== i)
            for (var l = 0, n = buttonsLeft.length; n > l; l++) {
              ...
              (m = o._buttonOffset),
                "undefined" == typeof m &&
                  (o._buttonOffset =
                    sliderActionLeftWidth - o.offsetLeft - o.offsetWidth),
                E(o, m);
            }
    ...
    var G = function (b) {
      ...
      if ("radio" !== c && "checkbox" !== c) {
        ...
        if (d.contains("mui-radio")) {
          ...
          f && ((f.checked = !f.checked), a.trigger(f, "change"));
    ...
    b.addEventListener("tap", function (b) {
      if (e) {
        ...
        if (f && f.classList.contains(j)) {
          ...
          return (
            i && i.classList.remove(h),
            d.add(h),
            void a.trigger(e, "selected", { el: e })
          );
        }
        if (
          ...
          if (
            (H.test(b.target.tagName) || b.detail.gesture.preventDefault(),
            !d.contains(g))
          ) {
      ...
      (a.fn.input = function (b) {
        ...
        return (
          this.each(function () {
            ...
            if (
              "range" === this.type &&
              e.classList.contains("mui-input-range")
            )
              d.push("slider");
            else {
            ...
            if (g) b = a.data[g];
              ...
              (g = ++a.uuid),
                (b = a.data[g] = new r(this, { actions: d.join(",") }));
    ...
    var b = "ontouchstart" in document,
      ...
      i = (a.Numbox = a.Class.extend({
        init: function (b, c) {
          ...
          (d.holder = b),
            d.holder.__numbox_inited ||
              ((d.holder.__numbox_inited = !0),
              (c = c || {}),
